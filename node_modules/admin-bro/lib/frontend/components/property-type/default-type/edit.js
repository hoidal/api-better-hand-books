...
const Edit = props => {
  ...
  }, property.label), property.availableValues ? /*#__PURE__*/_react.default.createElement(SelectEdit, props) : /*#__PURE__*/_react.default.createElement(TextEdit, props), /*#__PURE__*/_react.default.createElement(_designSystem.FormMessage, null, error && error.message));
};
...
const TextEdit = props => {
  ...
  const previous = (0, _usePrevious.default)(propValue);
  (0, _react.useEffect)(() => {
